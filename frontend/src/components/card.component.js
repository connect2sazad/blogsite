...
export const Card = ({ imageURL, categoryName, title, content, link, noOfViews, noOfComments, width ="md:w-1/3" }) => {
    return (
            ...
            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <div className="flex items-center flex-wrap ">
                        <Link to={link} className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">Learn More
